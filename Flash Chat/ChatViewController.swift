...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    var messageArray:[Message] = [Message]() //message array to take message text. it is empty
    ...
    func receiveMessages(){
        let messageDB = Database.database().reference().child("Message") // use the same reference name to retrieve database
